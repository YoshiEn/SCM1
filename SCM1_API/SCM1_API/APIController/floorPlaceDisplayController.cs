...
{
    public class floorPlaceDisplayController : ApiController
    {
        private SEAT_PresentationService presentationService;
        public floorPlaceDisplayController()
        {
        ...
        /// <returns></returns>
        [SwaggerOperation("FetchClientAreaSeat")]
        [LoggingFilter("api/floorPlaceDisplay")]
